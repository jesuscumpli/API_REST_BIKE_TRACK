...
url = 'http://' + QUANTUMLEAP_HOST + ':8668/v2/entities/urn:ngsi-ld:Station:001/attrs/state'
...
newHeaders = {'fiware-service': 'openiot', 'fiware-servicepath': '/'}
payload = {'lastN': 3}
url = 'http://' + QUANTUMLEAP_HOST + ':8668/v2/entities/urn:ngsi-ld:Station:001/attrs/id_user'
response = requests.get(url, headers=newHeaders, params=payload)
response.encoding = 'utf-8'
print(response.text)
...
newHeaders = {'fiware-service': 'openiot', 'fiware-servicepath': '/'}
url = 'http://' + QUANTUMLEAP_HOST + ':8668/v2/types/Station/attrs/temperature?lastN=4&georel=near;maxDistance:5000&geometry=point&coords=40.25,-3.41'
...
newHeaders = {'fiware-service': 'openiot', 'fiware-servicepath': '/'}
url = 'http://' + QUANTUMLEAP_HOST + ':8668/v2/types/Station/attrs/temperature?lastN=4&&georel=coveredBy&geometry=polygon&coords=41,-5;35,-5;35,0;41,0;41,-5'
response = requests.get(url, headers=newHeaders)
response.encoding = 'utf-8'
print(response.text)
